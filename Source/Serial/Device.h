  ...
  class Device
  {
    ...
    public:
      ...
      bool SendByte( uint8_t Byte, TransferOptions UseOptions = TO_Block)
      {
          ...
          else if( UseOptions & TO_ShortBlock)
          {
      ...
      bool SendLine( const char* String, TransferOptions UseOptions = TO_Block)
      {
      ...
      bool ReceiveLine
      (
          char* String, uint8_t BufferLength, uint8_t* Offset, TransferOptions UseOptions = TO_Block
      )
      {
